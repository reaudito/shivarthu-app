                                    ...
                                    {move || {
                                        if !transaction_status().is_empty() {
                                            view! {
                                                <div
                                                    role="alert"
                                                    class="flex items-center gap-3 p-4 mb-4 border-l-4 border-green-500 bg-green-100 text-green-800 rounded-xl shadow-md dark:bg-green-900 dark:text-green-200"
                                                >
                                                    {transaction_status()}
                                                </div>
                                            }
                                    ...
                                    {move || {
                                        if !transaction_event().is_empty() {
                                            view! {
                                                <div
                                                    role="alert"
                                                    class="flex items-center gap-3 p-4 border-l-4 border-yellow-500 bg-yellow-100 text-yellow-800 rounded-xl shadow-md dark:bg-yellow-900 dark:text-yellow-200"
                                                >
                                                    {transaction_event()}
                                                </div>
                                            }
