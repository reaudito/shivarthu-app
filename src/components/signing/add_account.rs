    ...
    let submit_click = move |e: SubmitEvent| {
        ...
        if !is_valid() {
            ...
            set_account_store.update(|acct| {
                ...
                acct.account_address = Some(account_string);
            });
                                ...
                                >
                                    ...
                                    {move || {
                                        if !error_message().is_empty() {
                                            view! {
                                                <>
                                                    <div role="alert" class="alert alert-error text-gray-900 dark:text-white">
                                                        <svg
                                                        ...
                                                        <span class="text-gray-900 dark:text-white">{error_message()}</span>
                                                    </div>
                                                    <br />
                                                </>
                                            }
                        ...
                        <>
                            <div class="max-w-sm mx-auto text-gray-900 dark:text-white">
                                <div role="alert" class="alert alert-info">
                                    ...
                                    <span class="text-gray-900 dark:text-white">"Sign in successful.".</span>
                                </div>
